 ...
 * AES解密
 */
export async function aesDecrypt(data: string, payload: string) {
  try {
    const payloadBuf = base64ToArrayBuffer(payload);
    ...
    const dataBuffer = new Uint8Array(base64ToArrayBuffer(data));
